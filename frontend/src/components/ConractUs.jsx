  ...
  return (
    <section className="py-16 bg-gray-50 text-black rounded-2xl">
      <div className="container mx-auto px-4 max-w-6xl">
        <h2 className="text-3xl md:text-4xl font-bold mb-12 text-amber-700 text-center">
          CONTACT US
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="order-2 md:order-1">
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full p-4 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-lg transition-colors duration-300"
              >
                SEND MESSAGE
              </button>
            </form>
